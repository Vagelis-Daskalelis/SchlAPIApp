...
using SchlAPIApp.Services;
using Serilog;
using Microsoft.IdentityModel.JsonWebTokens;
using SchlAPIApp.Helpers;
using UsersStudentsMVCApp.Configuration;

namespace SchlAPIApp
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddDbContext<SchlAPIAppDbContext>(options => options.UseSqlServer(connString));
